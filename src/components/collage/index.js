...
const Collage = () => {
    ...
    return (
        <CollageCont>
            <CollageItem onClick={() => openNewTab('https://example.com')} data-label="Content Scheduling"><img src={CollageImage1} alt="Scheduler" /></CollageItem>
            <CollageItem onClick={() => openNewTab('https://example.com')} data-label="Trivia Game Design"><img src={CollageGif2} alt="Web Development" /></CollageItem>
            <CollageItem onClick={() => openNewTab('https://example.com')} data-label="Email Onboarding"><img src={CollageImage3} alt="UI/UX Design" /></CollageItem>
